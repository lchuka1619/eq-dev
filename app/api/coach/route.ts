...
export async function POST(request: Request) {
  ...
  const prompt = [
    ...
    "Дасгалын нэр: " + (body.lessonTitle ?? "Харилцааны дасгал"),
    "Дасгалын зорилго нь бусад бүх ерөнхий шалгуураас давамгай.",
    "Хэрэглэгчийн аль хэдийн хийсэн зүйлийг improve талбарт дахин санал болгохыг ХАТУУ ХОРИГЛОНО.",
    "Бүх зорилгыг биелүүлсэн бол improve-д зөвхөн товч байдал эсвэл үгийн өнгийн нэг жижиг сайжруулалт өг.",
    "Энэ дасгалын цорын ганц зорилго: " + (body.lessonGoal ?? "Ойлгомжтой, тайван хариулах"),
